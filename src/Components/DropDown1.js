...
const DropDown = () => {
  ...
  useEffect(() => {
	...
	return (
		<div>
			<button onClick={handleClick1}>Semester2</button>

			{/* 👇️ show semester1 on click */}
			{isShown1 && (
				<div>

              <Add1 percentage={percentage} handleChange={handleChange} formInputData={formInputData} handleSubmit={handleSubmit}/>
              <Semester2 percentage={percentage} tableData={tableData}/>
